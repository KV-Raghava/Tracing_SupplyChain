...
function $() {
  for (var n2, u2, t3, r2, o2, f2, c3, s2 = 1; i.length; )
    i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t3 = void 0, o2 = (r2 = (u2 = n2).__v).__e, f2 = [], c3 = [], u2.__P && ((t3 = d({}, r2)).__v = r2.__v + 1, l.vnode && l.vnode(t3), O(u2.__P, t3, r2, u2.__n, u2.__P.namespaceURI, 32 & r2.__u ? [o2] : null, f2, null == o2 ? S(r2) : o2, !!(32 & r2.__u), c3), t3.__v = r2.__v, t3.__.__k[t3.__i] = t3, z(f2, t3, c3), t3.__e != o2 && C(t3)));
  $.__r = 0;
}
function I(n2, l2, u2, t3, i2, r2, o2, e2, f2, c3, s2) {
  ...
  for (f2 = P(u2, l2, _2, f2, m3), a3 = 0; a3 < m3; a3++)
    null != (v2 = u2.__k[a3]) && (h2 = -1 == v2.__i ? p : _2[v2.__i] || p, v2.__i = a3, g2 = O(n2, v2, h2, i2, r2, o2, e2, f2, c3, s2), w2 = v2.__e, v2.ref && h2.ref != v2.ref && (h2.ref && q(h2.ref, null, v2), s2.push(v2.ref, v2.__c || w2, v2)), null == d2 && null != w2 && (d2 = w2), 4 & v2.__u || h2.__k === v2.__k ? f2 = A(v2, f2, n2) : "function" == typeof v2.type && void 0 !== g2 ? f2 = g2 : w2 && (f2 = w2.nextSibling), v2.__u &= -7);
  return u2.__e = d2, f2;
}
function P(n2, l2, u2, t3, i2) {
  ...
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t3 && (t3 = S(e2)), B(e2, e2));
  return t3;
}
function A(n2, l2, u2) {
  var t3, i2;
...
function j(n2, l2, u2, t3, i2) {
  ...
  n:
    if ("style" == l2)
      ...
      r2 = l2 != (l2 = l2.replace(f, "$1")), l2 = l2.toLowerCase() in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? l2.toLowerCase().slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t3 ? u2.u = t3.u : (u2.u = c, n2.addEventListener(l2, r2 ? a : s, r2)) : n2.removeEventListener(l2, r2 ? a : s, r2);
    else {
...
function O(n2, u2, t3, i2, r2, o2, e2, f2, c3, s2) {
  ...
  n:
    if ("function" == typeof j2)
      try {
        if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C2 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C2 ? C2.props.value : a3.__ : i2, t3.__c ? m3 = (h2 = u2.__c = t3.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = D), C2 && C2.sub(h2), h2.props = b, h2.state || (h2.state = {}), h2.context = M2, h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = d({}, h2.__s)), d(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), y3 = h2.props, v2 = h2.state, h2.__v = u2, p2)
      ...
      null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = V(t3.__e, u2, t3, i2, r2, o2, e2, c3, s2);
...
function V(u2, t3, i2, r2, o2, e2, f2, c3, s2) {
  ...
  if (null == x3)
    ...
    for (a3 in k2)
      d2 = k2[a3], "children" == a3 ? v2 = d2 : "dangerouslySetInnerHTML" == a3 ? h2 = d2 : "value" == a3 ? _2 = d2 : "checked" == a3 ? m3 = d2 : c3 && "function" != typeof d2 || b[a3] === d2 || j(u2, a3, d2, b[a3], o2);
    if (h2)
      c3 || y3 && (h2.__html == y3.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (y3 && (u2.innerHTML = ""), I("template" == t3.type ? u2.content : u2, w(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && S(i2, 0), c3, s2), null != e2)
      for (a3 = e2.length; a3--; )
        g(e2[a3]);
...
function B(n2, u2, t3) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && B(i2[r2], u2, t3 || "function" != typeof n2.type);
